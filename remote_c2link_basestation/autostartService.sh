...
#/home/kios/Documents/remote_c2link_basestation/launch/AutostartOpenVpn.sh
...
su - -c 'cd Documents/remote_c2link_basestation; ./launch/AutostartMultimasterOSDK.sh 2>&1 | tee std.out' $directoryOwner
